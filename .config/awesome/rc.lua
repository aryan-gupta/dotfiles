...
root.buttons(gears.table.join(
    awful.button({ }       , leftclick, function (c) client.focus = c; c:raise() end),
    awful.button({ modkey }, leftclick, awful.mouse.client.move),
    awful.button({ modkey }, rightclick, awful.mouse.client.resize))
    awful.button({ modkey }, scrollup, awful.tag.viewnext),
    awful.button({ modkey }, scrolldown, awful.tag.viewprev),
    awful.button({ "Control" }, scrollup, function () awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ +2%") end),
    awful.button({ "Control" }, scrolldown, function () awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ -2%") end),
    awful.button({ "Control" }, middleclick, function () awful.spawn("pactl set-sink-mute @DEFAULT_SINK@ toggle") end)
))
-- }}}
...
globalkeys = gears.table.join(
    ...
    awful.key(
        { modkey },
        "space",
        function () awful.spawn("rofi -show drun -theme launcher -kb-cancel \"super+space,Escape\"") end,
        {description = "open program launcher", group = "layout"}
    ),
    awful.key(
        { modkey },
        "e",
        function () awful.spawn("~/.config/rofi/power.sh -kb-cancel \"super+e,Escape\"") end,
        {description = "open power menu", group = "layout"}
    ),
    awful.key(
        {  },
        "Print",
    ...
    awful.key(
        { "Shift" },
        "Print",
        function () awful.spawn("flameshot full -c -p ~/Pictures") end,
        {description = "open power menu", group = "layout"}
    ),
    awful.key(
        {  },
    ...
    awful.key(
        { "Alt" },
        "c",
        function () awful.spawn("chromium --new-window") end,
        {description = "open power menu", group = "layout"}
    ),
    awful.key(
        { "Alt" },
        "i",
        function () awful.spawn("chromium --incognito") end,
        {description = "open power menu", group = "layout"}
    ),
    awful.key(
        { "Alt" },
        "x",
        function () awful.spawn("code -n") end,
        {description = "open power menu", group = "layout"}
    ),
    awful.key(
        { "Alt" },
        "t",
        function () awful.spawn("~/.config/bspwm/open_terminal_here") end,
        {description = "open power menu", group = "layout"}
    ),
    awful.key(
        { "Alt" },
        "f",
        function () awful.spawn("nautilus --new-window") end,
        {description = "open power menu", group = "layout"}
    ),
    awful.key(
        { "Alt" },
    ...
    awful.key(
        { "Alt" },
        "w",
        function () awful.spawn("virt-manager --connect qemu:///system --show-domain-console ubuntu-work-vm") end,
        {description = "open power menu", group = "layout"}
    ),
